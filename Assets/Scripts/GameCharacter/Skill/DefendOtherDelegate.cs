...
{
    class DefendOtherDelegate : SkillDelegate
    {
        ITargetable _defenderTarget;
        ISkillUsable _defenderUser;
        ITargetable _target;

        public DefendOtherDelegate(ITargetable defender_, double coeff_, double cooldown_, double range_, double delay_) : base( coeff_, cooldown_, range_, delay_ )
        {
